...
def filtrlar(request):
    # ← SIZNING KODINGIZ:
        context = {"matn": "salom dunyo","son": 5,"ism": "",}
        return render(request, "main/filtrlar.html", context)
...
def static_test(request):
    # ← SIZNING KODINGIZ:
        return render(request, "main/static_test.html", {"sarlavha": "Statik fayl ishlayapti!"})
